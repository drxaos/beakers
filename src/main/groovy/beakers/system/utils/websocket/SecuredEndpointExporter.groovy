...
class SecuredEndpointExporter extends ServerEndpointExporter {
    ...
    protected void registerEndpoints() {
        ...
        for (Class<?> endpointClass : endpointClasses) {
            ...
            // Method mapping
            PojoMethodMapping methodMapping = new PojoMethodMapping(AbstractEndpoint, annotation.decoders(), path);

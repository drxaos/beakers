...
CREATE TABLE sys_mail_log (id BIGINT(19) AUTO_INCREMENT NOT NULL, version BIGINT(19) NOT NULL, date TIMESTAMP, sender VARCHAR(255), subject VARCHAR(255), text CLOB, to_email VARCHAR(255), view VARCHAR(255), CONSTRAINT CONSTRAINT_A PRIMARY KEY (id));
